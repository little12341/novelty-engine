...
export default function Home() {
  return (
    <main id="top">
      ...
      <section className="plain-section changes-section" aria-labelledby="changes-title"><div className="page-width changes-layout"><header><p className="eyebrow">User-triggered comparisons</p><h2 id="changes-title">See how the market changes.</h2></header><div className="changes-copy"><p>Run the same research again later to compare new competitors, changing complaints, pricing updates, stronger evidence, and new reasons an opportunity may no longer be attractive.</p><p>Reruns happen only when you request them. Novelty Engine does not claim automatic month-to-month monitoring.</p></div></div></section>
