...
const expectedAppPaths = ["/api/mcp/route", "/api/mcp/health/route", "/api/research/route", "/api/research/history/route", "/api/research/export/route", "/api/research/feedback/route", "/api/research/memory/route", "/api/research/watchlists/route", "/api/research/watchlists/check/route"];
const expectedRoutes = ["/api/mcp", "/api/mcp/health", "/api/research", "/api/research/history", "/api/research/export", "/api/research/feedback", "/api/research/memory", "/api/research/watchlists", "/api/research/watchlists/check"];
