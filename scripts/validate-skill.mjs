...
for (const phrase of ["Research-first operating mode", "scripts/research.mjs", "graceful fallback", "Never invent a competitor", "evidence-backed market gap", "finalOpportunities", "falsification", "Evidence lineage", "24–72", "heuristic"]) {
  if (!text.includes(phrase)) throw new Error(`SKILL.md is missing required V2 instruction: ${phrase}`);
}
...
console.log("Validated novelty-engine Skill structure and V2 research contract.");
