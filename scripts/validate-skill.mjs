...
for (const phrase of ["Research-first operating mode", "Remote MCP (preferred)", "research_market", "run_research_mode", "compare_ideas", "/research-company", "/compare-ideas", "slash-like strings", "/commands", "/help", "Novelty:source_check", "fresh_expand", "untrusted data", "falsify_opportunity", "scripts/research.mjs", "NOVELTY_RESEARCH_API_URL", "graceful fallback", "non-researched, hypothesis-led ideation", "Never invent a competitor", "evidence-backed market gap", "finalOutput", "VERIFIED", "INFERRED", "UNKNOWN", "stopDecision", "insufficient_evidence", "Rejected Ideas + Why", "Decisive Risks", "24–72", "heuristic"]) {
