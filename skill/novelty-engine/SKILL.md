...
| `/customer-pain` | Mine recurring complaints, workarounds, churn reasons, and requested outcomes. | `/customer-pain <customer and workflow>` | Claude/web search → `Novelty:research_from_sources`, emphasizing independent user voice | `/customer-pain independent adjusters preparing claim evidence` |
