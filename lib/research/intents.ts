...
export const NOVELTY_COMMAND_CATALOG = Object.freeze([
  { command: "/research-market", description: "Run the complete evidence-first market research pipeline.", usage: "/research-market <market or problem>", example: "/research-market scheduling tools for independent dental labs" },
  { command: "/find-gaps", description: "Find structural market gaps for a new query or inspect gaps in the current run.", usage: "/find-gaps <market or run ID>", example: "/find-gaps field-service invoicing for teams under five" },
  { command: "/inspect-competitors", description: "Inspect competitors and substitutes in the current run or research a new market.", usage: "/inspect-competitors [run ID or market]", example: "/inspect-competitors research_20260827120000_example" },
  ...
  { command: "/research-company", description: "Research a company, its market, positioning, competitors, and exposed gaps.", usage: "/research-company <company>", example: "/research-company ServiceTitan" },
  ...
  { command: "/compare", description: "Compare two to five ideas under one evidence and budget framework.", usage: "/compare <idea> vs <idea> [vs ...]", example: "/compare mobile tire dispatch vs appliance repair logistics" },
  ...
  { command: "/customer-pain", description: "Mine recurring complaints, workarounds, churn reasons, and requested outcomes.", usage: "/customer-pain <customer and workflow>", example: "/customer-pain independent adjusters preparing claim evidence" },
  ...
  { command: "/summarize-run", description: "Retrieve a concise summary of the current or specified research run.", usage: "/summarize-run [run ID]", example: "/summarize-run research_20260827120000_example" },
  ...
  { command: "/export", description: "Export the current or specified run in a supported output format.", usage: "/export [run ID] [json|markdown|print|csv|competitor_matrix|validation_plan|opportunity_brief|investor_memo|bibliography]", example: "/export research_20260827120000_example csv" },
