...
const marketRows: ProviderSearchResult[] = [
  ...
  { url: "https://community.contractors.example/workaround-7", title: "Spreadsheet and text workaround", snippet: "Independent contractors still use spreadsheets and text messages and would pay to stop duplicate entry.", publishedAt: "2026-06-02" },
